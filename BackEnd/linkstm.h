...
//        WriteBi2Id = 0x67,              // Запись данных в определитель Би2
    ...
    enum RxCommand : quint8 {           // Принимаемые команды
        ...
        GenStopCoagComplete = 0x41,     // Коагуляция завершена
        GenStopShortTerm = 0x42,        // КЗ бранш ТЕРМОШОВ
        ...
        GenNoArcBiTur = 0x46,           // Не зажглась дуга в БИ-ТУР за 3 сек
        GenStopShortBiTur = 0x47,       // КЗ бранш БИ-ТУР
        GenStopTimeTerm = 0x48,         // Предельное время активации ТЕРМОШОВ
...
public slots:
    ...
    void argonBlow();                                   // Начать продувку газового тракта
    void setArgonBlowing(bool blowing);                 // Вкл/выкл непрерывную передачу ArgonBlow
...
//    QByteArray* m_txPacket;
    ...
    bool m_argonBlowing = false;        // Непрерывная передача ArgonBlow, пока идёт продувка
